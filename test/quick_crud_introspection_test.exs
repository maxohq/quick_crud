defmodule QuickCrudIntrospectionTest do
  @moduledoc """
  ...
  describe "ecto" do
    ...
    test "associations - company" do
      ...
      assert %Ecto.Association.BelongsTo{
               field: :company,
               owner: QuickCrud.User,
               related: QuickCrud.Company,
               owner_key: :company_id,
               related_key: :id,
               queryable: QuickCrud.Company,
               on_cast: nil,
               on_replace: :raise,
               where: [],
               defaults: [],
    ...
    test "associations - posts" do
      ...
      assert %Ecto.Association.Has{
               ...
               owner: QuickCrud.User,
               owner_key: :id,
               queryable: QuickCrud.Post,
               related: QuickCrud.Post,
               related_key: :user_id,
               relationship: :child,
               unique: true,
               where: [],
    ...
    test "associations - likes" do
      ...
      assert %Ecto.Association.Has{
               ...
               owner: QuickCrud.User,
               owner_key: :id,
               queryable: QuickCrud.Like,
               related: QuickCrud.Like,
               related_key: :user_id,
               relationship: :child,
               unique: true,
               where: [],
