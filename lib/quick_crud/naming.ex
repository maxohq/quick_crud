defmodule QuickCrud.Naming do
  ...
  ## Examples
      ...
      iex> QuickCrud.Naming.resource_name(MyApp.User)
      "user"

      iex> QuickCrud.Naming.resource_name(MyApp.UserView, "View")
      "user"
  ...
  ## Examples
      ...
      iex> QuickCrud.Naming.unsuffix("MyApp.User", "View")
      "MyApp.User"

      iex> QuickCrud.Naming.unsuffix("MyApp.UserView", "View")
      "MyApp.User"
  ...
  ## Examples
      ...
      iex> QuickCrud.Naming.underscore("MyApp")
      "my_app"

  In general, `underscore` can be thought of as the reverse of
  `camelize`, however, in some cases formatting may be lost:

      QuickCrud.Naming.underscore "SAPExample"  #=> "sap_example"
      QuickCrud.Naming.camelize   "sap_example" #=> "SapExample"
  ...
  ## Examples
      ...
      iex> QuickCrud.Naming.camelize("my_app")
      "MyApp"

      iex> QuickCrud.Naming.camelize("my_app", :lower)
      "myApp"
  ...
  ## Examples
      ...
      iex> QuickCrud.Naming.humanize(:username)
      "Username"
      iex> QuickCrud.Naming.humanize(:created_at)
      "Created at"
      iex> QuickCrud.Naming.humanize("user_id")
      "User"
